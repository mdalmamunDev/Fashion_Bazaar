                ...
                <div class="col-xl-6 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-5">
                                <p class="mb-0">Permanently delete this account?</p>
                                <a onclick="return confirm('Are you sure to delete this account?')" href="{{ route('user.delete', $user->id) }}" class="text-danger">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
