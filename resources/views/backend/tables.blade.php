            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0  d-flex justify-content-between">
                        <h6>Users table</h6>
                        <a href="{{ route('user.list')  }}" class="btn btn-primary">All Users</a>
                    </div>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.pro.list') }}" type="button" class="btn btn-primary">All Products</a>
                    </div>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        ...
                        <a href="{{route('cat.list')}}" type="button" class="btn btn-primary">All Categorys</a>
                    </div>
