<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main" style="background: #dbd5dd">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @endcomponent
            @component('backend.layouts.nav-item', [
                'link' => url('admin/tables'),
                'active' => request()->is('admin/tables'),
            ...
            @endcomponent
            @component('backend.layouts.nav-item', [
                'link' => url('admin/billing'),
                'active' => request()->is('admin/billing'),
                'icon' => '<svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            @endcomponent
            @component('backend.layouts.nav-item', [
                'link' => route('admin.pro.list'),
                'active' => request()->is('admin/product/list'),
                'icon' => '<svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>product_hunt [#135]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-420.000000, -7559.000000)" fill="#000000"> <g id="icons" transform="translate(56.000000, 160.000000)"> <path d="M376.5,7408 C376.5,7408.69 375.957,7409 375.289,7409 L373,7409 L373,7407 L375.289,7407 C375.957,7407 376.5,7407.31 376.5,7408 M375.27,7411 L373,7411 L373,7413 L371,7413 L371,7405 L375.27,7405 C376.777,7405 378,7406.473 378,7408 C378,7409.488 376.777,7410 375.27,7411 M374,7399 C368.477,7399 364,7403.477 364,7409 C364,7414.523 368.477,7419 374,7419 C379.523,7419 384,7414.523 384,7409 C384,7403.477 379.523,7399 374,7399" id="product_hunt-[#135]"> </path> </g> </g> </g> </g></svg>',
                'name' => 'Products'
            ])
            @endcomponent
            @component('backend.layouts.nav-item', [
                'link' => route('cat.list'),
                'active' => request()->is('admin/category/list'),
                'icon' => '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g clip-path="url(#clip0_429_11052)"> <circle cx="17" cy="7" r="3" stroke="#292929" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></circle> <circle cx="7" cy="17" r="3" stroke="#292929" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></circle> <path d="M14 14H20V19C20 19.5523 19.5523 20 19 20H15C14.4477 20 14 19.5523 14 19V14Z" stroke="#292929" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M4 4H10V9C10 9.55228 9.55228 10 9 10H5C4.44772 10 4 9.55228 4 9V4Z" stroke="#292929" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></path> </g> <defs> <clipPath id="clip0_429_11052"> <rect width="24" height="24" fill="white"></rect> </clipPath> </defs> </g></svg>',
                'name' => 'Categories'
            ])
            @endcomponent
        </ul>
